...
import appointmentRes from "./endpoints/AppointmentResponse/router";
...
import communicationReq from "./endpoints/CommunicationRequest/router";
...
app.use(urlPrefix + "/appointmentRes", appointmentRes);
...
app.use(urlPrefix + "/communicationReq", communicationReq);
