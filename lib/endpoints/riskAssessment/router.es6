...
let {NODE_ENV} = process.env,
  ...
  riskAssessmentRootRoute = router.route("/"),
  riskAssessmentParamRoute = router.route("/:id");

riskAssessmentParamRoute
  .get(serviceMapperInstance.retrieveRiskAssessment.bind(serviceMapperInstance));

riskAssessmentRootRoute
  .post(serviceMapperInstance.createRiskAssessment.bind(serviceMapperInstance));
