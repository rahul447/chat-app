...
export class ServiceMapper {
  ...
  createBodySite(req, res, next) {
    console.log("========= Create BodySite===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.bodySite.create,
  ...
  retrieveBodySite(req, res, next) {
    console.log("========= Retrieve BodySite ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.bodySite.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
