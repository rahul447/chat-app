...
export class ServiceMapper {
  ...
  createCoverage(req, res, next) {
    console.log("========= Create Coverage ===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.coverage.create,
  ...
  retrieveCoverage(req, res, next) {
    console.log("========= Retrieve Coverage ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.coverage.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
