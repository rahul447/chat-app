...
export class ServiceMapper {
  ...
  createProvenance(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.provenance.create,
  ...
  retrieveProvenance(req, res, next) {
    console.log("========= Retrieve Provenance===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.provenance.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
