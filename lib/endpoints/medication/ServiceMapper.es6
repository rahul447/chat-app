...
export class ServiceMapper {
  ...
  createMedication(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.medication.create,
  ...
  retrieveMedication(req, res, next) {
    console.log("========= Retrieve Medication ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.medication.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
