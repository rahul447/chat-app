...
export class ServiceMapper {
  ...
  createContract(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.contract.create,
  ...
  retrieveContract(req, res, next) {
    console.log("========= Retrieve Contract===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.contract.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
