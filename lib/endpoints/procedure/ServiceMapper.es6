...
export class ServiceMapper {
  ...
  createProcedure(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.procedure.create,
  ...
  retrieveProcedure(req, res, next) {
    console.log("========= Retrieve Procedure ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.procedure.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
