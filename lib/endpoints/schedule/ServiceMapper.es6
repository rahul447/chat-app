...
export class ServiceMapper {
  ...
  createSchedule(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.schedule.create,
  ...
  retrieveSchedule(req, res, next) {
    console.log("========= Retrieve Schedule ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.schedule.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
