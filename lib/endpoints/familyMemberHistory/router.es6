...
let {NODE_ENV} = process.env,
  ...
  urlBase = `${config.http.protocol}://${config.http.domain}:${config.http.port}/familyMemberHistory`,
  ...
  familyMemberHistoryRootRoute = router.route("/"),
  familyMemberHistoryParamRoute = router.route("/:id");

familyMemberHistoryParamRoute
  .get(serviceMapperInstance.retrieveFamilyMemberHistory.bind(serviceMapperInstance));

familyMemberHistoryRootRoute
  .post(serviceMapperInstance.createFamilyMemberHistory.bind(serviceMapperInstance));
