...
export class ServiceMapper {
  ...
  createCarePlan(req, res, next) {
    console.log("========= Create CarePlan ===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.carePlan.create,
  ...
  retrieveCarePlan(req, res, next) {
    console.log("========= Retrieve CarePlan ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.carePlan.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
