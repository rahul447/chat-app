...
let {NODE_ENV} = process.env,
  ...
  urlBase = `${config.http.protocol}://${config.http.domain}:${config.http.port}/imagingObjectSelection`,
  ...
  imagingObjectSelecRootRoute = router.route("/"),
  imagingObjectSelecParamRoute = router.route("/:id");

imagingObjectSelecParamRoute
  .get(serviceMapperInstance.retrieveImagingObjectSelection.bind(serviceMapperInstance));

imagingObjectSelecRootRoute
  .post(serviceMapperInstance.createImagingObjectSelection.bind(serviceMapperInstance));
