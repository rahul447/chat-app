...
export class ServiceMapper {
  ...
  createComposition(req, res, next) {
    console.log("========= Create Composition ===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.composition.create,
  ...
  retrieveComposition(req, res, next) {
    console.log("========= Retrieve Composition ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.composition.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
