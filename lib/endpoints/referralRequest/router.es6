...
let {NODE_ENV} = process.env,
  ...
  urlBase = `${config.http.protocol}://${config.http.domain}:${config.http.port}/referralRequest`,
  ...
  referralRequestRootRoute = router.route("/"),
  referralRequestParamRoute = router.route("/:id");

referralRequestParamRoute
  .get(serviceMapperInstance.retrieveReferralRequest.bind(serviceMapperInstance));

referralRequestRootRoute
  .post(serviceMapperInstance.createReferralRequest.bind(serviceMapperInstance));
