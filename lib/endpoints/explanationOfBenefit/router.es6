...
let {NODE_ENV} = process.env,
  ...
  urlBase = `${config.http.protocol}://${config.http.domain}:${config.http.port}/explanationOfBenefit`,
  ...
  explanationOfBenefitRootRoute = router.route("/"),
  explanationOfBenefitParamRoute = router.route("/:id");

explanationOfBenefitParamRoute
  .get(serviceMapperInstance.retrieveExplanationOfBenefit.bind(serviceMapperInstance));

explanationOfBenefitRootRoute
  .post(serviceMapperInstance.createExplanationOfBenefit.bind(serviceMapperInstance));
