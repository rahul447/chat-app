...
let {NODE_ENV} = process.env,
  ...
  urlBase = `${config.http.protocol}://${config.http.domain}:${config.http.port}/immunizationRecommendation`,
  ...
  immunizationRecommRootRoute = router.route("/"),
  immunizationRecommParamRoute = router.route("/:id");

immunizationRecommParamRoute
  .get(serviceMapperInstance.retrieveImmunizationRecommendation.bind(serviceMapperInstance));

immunizationRecommRootRoute
  .post(serviceMapperInstance.createImmunizationRecommendation.bind(serviceMapperInstance));
