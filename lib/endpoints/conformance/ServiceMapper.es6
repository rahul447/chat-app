...
export class ServiceMapper {
  ...
  createConformance(req, res, next) {
    console.log("========= Create CommunicationRequest===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.conformance.create,
  ...
  retrieveConformance(req, res, next) {
    console.log("========= Retrieve Conformance ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.conformance.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
