...
export class ServiceMapper {
  ...
  createAppointment(req, res, next) {
    ...
    this.mapperMaster.processCudRequest({
      ...
      "event": this.events.fhirResources.appointment.create,
  ...
  retrieveAppointment(req, res, next) {
    console.log("========= Retrieve Appointment ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.appointment.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
