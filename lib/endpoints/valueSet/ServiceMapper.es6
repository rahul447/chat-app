...
export class ServiceMapper {
  ...
  createValueSet(req, res, next) {
    console.log("========= Create ValueSet ===========");
    this.mapperMaster.processCudRequest({
      "service": this.serviceInstance,
      "event": this.events.fhirResources.valueSet.create,
  ...
  retrieveValueSet(req, res, next) {
    console.log("========= Retrieve ValueSet ===========");
    console.log(req.params);
    let obj = {
      "id": req.params.id,
      "service": this.serviceInstance,
      "event": this.events.fhirResources.valueSet.retrieve,
      "res": res,
      "req": req,
      "next": next
    };
